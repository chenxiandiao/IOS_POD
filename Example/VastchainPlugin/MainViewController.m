...
//    BlueViewController *viewController = [[BlueViewController alloc]initWithUrl:@"http://10.144.1.116:10086/#"];
//    BlueViewController *viewController = [[BlueViewController alloc]initWithUrl:@"https://m.baidu.com/"];
    BlueViewController *viewController = [[BlueViewController alloc]initWithUrl:@"http://10.144.1.116/#/storehouse/home?token=toyPfamrYeMc15IuhnLrqQeP2YKA6dYu&org_id=271955190993424384"];
